...
SNNname = rospy.get_param("/connectivity_joytest/SNNname")
verbose = rospy.get_param("/connectivity_joytest/verbose")
pathSNN = rospy.get_param("/connectivity_joytest/path")
xml = rospy.get_param("/connectivity_joytest/xml") 

sensory_neurons = rospy.get_param("/connectivity_joytest/sensory_neurons")
motor_neurons = rospy.get_param("/connectivity_joytest/motor_neurons")
inter_neurons = rospy.get_param("/connectivity_joytest/inter_neurons")
inter_layers = rospy.get_param("/connectivity_joytest/inter_layers")
synapse_weight = str(rospy.get_param("/connectivity_joytest/synapse_weight"))
synapse_delay = str(rospy.get_param("/connectivity_joytest/synapse_delay"))
synapse_condition = rospy.get_param("/connectivity_joytest/synapse_condition")
input_drive_current = rospy.get_param("/connectivity_joytest/input_drive_current")
tau = rospy.get_param("/connectivity_joytest/tau") * ms
threshold_value = rospy.get_param("/connectivity_joytest/threshold")
refractory_value = rospy.get_param("/connectivity_joytest/refractory") * ms
reset_value = rospy.get_param("/connectivity_joytest/reset")
simulation_lenght_ms = rospy.get_param("/connectivity_joytest/simulation_lenght") * ms
simulation_lenght_int = rospy.get_param("/connectivity_joytest/simulation_lenght") 
...
rospy.init_node('node_connectivity_'+SNNname, anonymous=True)
rospy.loginfo("SNN - Connectivity - " + SNNname)
